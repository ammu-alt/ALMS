<?php
    ...
    //{
      //  header('Location: http://localhost/ALMS/abc.php');
    //}
?><!DOCTYPE html>
<html lang="en">
                  ...
                  <th>Taluk</th>
                            ...
                            <td>'.$rows['TALUK'].'</td>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                  <a class="dropdown-item" href="voverify/approve.php?villageid='.$rows['VILLAGE_ID'].'"><i class="fa fa-eye"></i> Approve</a>
